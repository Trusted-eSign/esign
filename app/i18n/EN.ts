export default {
  ...
  License: {
    ...
    overtimes_license_confirm: "To send a request for a temporary license for the CryptoARM GOST product, for a period of 90 days, fill out the form floor. A temporary license is issued once per workplace to familiarize yourself with all the features of the software product.",
    overtimes_license: "In the absence of a permanent license, you can request a temporary license. The temporary license is issued for a period of 90 days and provides full-fledged work with the application.",
