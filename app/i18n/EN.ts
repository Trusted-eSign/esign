export default {
  ...
  About: {
    ...
    version: "Version 1.1.0 for Windows",
    ...
    Contacts: "Contacts",
    Info: "Info",
    about_programm: "Trusted eSign is a desktop app that allows you to sign documents and encrypt files using digital certificates and cryptographic algorithms.",
