export default {
  ...
  Events: {
    ...
    operations_log: "Operations log",
    cert_generation: "Certificate generate",
  ...
  CSR: {
    ...
    TZ: "Tanzania, United Republic (TZ)", 
    TL: "Timor-Leste (TL)", 
    TG: "Togo (TG)", 
    TK: "Tokelau (TK)", 
    TO: "Tonga (TO)",
  ...
  Help: {
    ...
    Paragraf_1_2b: "Trusted eSign v.1.3.0 User guide.pdf",
  ...
  Problems: {
    ...
    resolve_5_3: "If you have certificates on a token, you can install them with a link to a key container on the сontainers page.",
