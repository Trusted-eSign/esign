export default {
  ...
  Problems: {
    ...
    resolve_2_1: "Для решения данной проблемы можно приобрести лицензию на продукт в электронном магазине, доступном по ссылке ",
    resolve_2_2: "",
    resolve_2_3: "",
    ...
    resolve_4_1: "",
    problem_5: "Не обнаружены сертификаты для подписи",
    resolve_5: "Подключите считыватель и перейдите на старницу Контейнеры, на которой установите сертификат",
  },
  Algorithm: {
