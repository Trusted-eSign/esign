export default {
  ...
  Problems: {
    ...
    resolve_6_2: "Для решения данной проблемы сформируйте лог приложения и перешлите его в службу технической поддержки.", 
    resolve_6_3: "Подробные инструкции по созданию лог-файла под требуемой платформой можно найти в документации по продукту, которая доступна по ссылке ", 
  },
  Algorithm: {
