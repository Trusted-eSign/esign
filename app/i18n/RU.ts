export default {
  ...
  Help: {
    ...
    Paragraf_1_2b: "КриптоАРМ ГОСТ v.1.2.0 Руководство пользователя.pdf",
    ...
    link_user_guide_name: " КриптоАРМ ГОСТ v.1.2.0 Руководство пользователя.pdf",
  ...
  License: {
    ...
    link_buy_license: "http://www.trusted.ru/support/downloads/?product=133",
    ...
    overtimes_license_confirm: "Для отправки запроса на получение временной лицензии на продукт КриптоАРМ ГОСТ, сроком на 90 дней, заполните полу формы. Временная лицензия выдается один раз на одно рабочее место для знакомства со всеми возможностями программного продукта.",
    overtimes_license: "При отсутствии постоянной лицензии, Вы можете сделать запрос на получение временной лицензии. Временная лицензия выдается сроком на 90 дней и обеспечивает полноценную работу с приложением.",
  ...
  Problems: {
    ...
    resolve_3_3: "Для решения данной проблемы можно приобрести лицензию на продукт в электронном магазине, доступном по ссылке ",
    ...
    resolve_5_3: "Установка доступных сертификататов производится на странице Контейнеры.",
